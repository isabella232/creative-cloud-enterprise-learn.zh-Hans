...
# Creative Cloud企业版快速参考指南

![Creative Cloud英雄图像](../assets/CCEbanner.png)

作为企业创意人员，您必须与分布式团队协作，建立可扩展的流程，并遵守企业系统和准则。 这些快速参考指南(PDF)可帮助您了解Creative Cloud中的新增功能。
...
<tr>
 <td>
   ...
   <a href="GettingStartedwithCloudDocuments.pdf" target="_blank"><strong>云文档快速入门(PDF)</strong></a>
    ...
    <em>从一台设备创建文档，然后继续在另一台设备上使用该文档。 了解如何将文档移动到云中，以便随时随地访问文档</em>
    <br>
  </td>
  <td>
   <a href="ScanShareandReviewPDFswithCreativeCloud.pdf" target="_blank">
      <img alt="扫描、共享和审阅PDF及Creative Cloud" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
   <a href="ScanShareandReviewPDFswithCreativeCloud.pdf" target="_blank"><strong>扫描、共享和审阅PDF与Creative Cloud(PDF)</strong></a>
    </div>
    <em>了解如何使用Adobe Scan和Document Cloud捕获、裁剪纸质表单并将其转换为功能齐全的PDF文件，然后使用Acrobat填写、签署和共享您的信息</em>
    <br>
  </td>
 <td>
   <a href="ShootEditPublishyourPhotoswithCreativeCloud.pdf" target="_blank">
    ...
    <div>
   <a href="ShootEditPublishyourPhotoswithCreativeCloud.pdf" target="_blank"><strong>拍摄、编辑、发布带有Creative Cloud的照片(PDF)</strong></a>
    </div>
  ...
  <td>
   <a href="SketchCompandFinalizeaBrochureLayoutwithCreativeCloud.pdf" target="_blank">
    ...
    <div>
   <a href="SketchCompandFinalizeaBrochureLayoutwithCreativeCloud.pdf" target="_blank"><strong>使用Creative Cloud素描、合成和定版小册子版面(PDF)</strong></a>
    </div>
...
<tr>
  <td>
   <a href="UnlimitedAdobeFontsatyourFingertips.pdf" target="_blank">
    ...
    <div>
   <a href="UnlimitedAdobeFontsatyourFingertips.pdf" target="_blank"><strong>无限Adobe Fonts触手可及(PDF)</strong></a>
    </div>
...
<tr>
 <td>
   <a href="Frescoworkshop.pdf" target="_blank">
    ...
    <div>
   <a href="Frescoworkshop.pdf" target="_blank"><strong>尝试在iPad(和iPhone)上Fresco您的手(PDF)</strong></a>
    </div>
...
<tr>
 ...
 <td>
   <a href="AnyonecanbecreativewithCreativeCloud.pdf" target="_blank">
      <img alt="任何人都可以创新Creative Cloud" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
   <a href="AnyonecanbecreativewithCreativeCloud.pdf" target="_blank"><strong>任何人都可以创作Creative Cloud(PDF)</strong></a>
    </div>
    <em>跟着这个快速技巧一起操作，它向您展示如何使用Camera Raw滤镜在任何照片中呈现最佳效果</em>
    <br>
  </td>
  <td>
  ...
  <td>
   <a href="CreateJaw-DroppingGraphicswithPhotoshopAfterEffects.pdf" target="_blank">
    ...
    <div>
   <a href="CreateJaw-DroppingGraphicswithPhotoshopAfterEffects.pdf" target="_blank"><strong>使用Photoshop + After Effects创建令人瞠目的图形(PDF)</strong></a>
    </div>
...
<tr>
  <td>
   ...
   <a href="GettoknowPhotoshopontheiPad.pdf" target="_blank"><strong>了解Photoshop iPad版(PDF)</strong></a>
    ...
    <em>通过重新设计的基于触控的界面，将Photoshop的强大功能带到您的指尖</em>
    <br>
  </td>
  <td>
...
<tr>
  <td>
   <a href="CreateUniqueGraphicsbyCombiningAdobeStockImages.pdf" target="_blank">
      <img alt="通过合并图形创建独特的Adobe [!DNL Stock] 图像" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
   <a href="CreateUniqueGraphicsbyCombiningAdobeStockImages.pdf" target="_blank"><strong>通过合并图形创建独特的Adobe [!DNL Stock] 图像(PDF)</strong></a>
    </div>
    <em>从Adobe中组合图像 [!DNL Stock] 为您的设计项目创建全新的图像</em>
    <br>
  </td>
  <td>
   <a href="EnhanceYourPortfoliowithUniqueProjectsandAdobeStock.pdf" target="_blank">
      <img alt="利用独特的Portfolio和Adobe [!DNL Stock]" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
   <a href="EnhanceYourPortfoliowithUniqueProjectsandAdobeStock.pdf" target="_blank"><strong>利用独特的Portfolio和Adobe [!DNL Stock] (PDF)</strong></a>
    </div>
    <em>从Adobe中组合图像 [!DNL Stock] 为您的设计项目创建全新的图像</em>
    <br>
  </td>
   ...
   <a href="GetMoreAttentionwithMotionfromAdobeStock.pdf" target="_blank">
      <img alt="通过Adobe中的运动获得更多关注 [!DNL Stock]" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
   <a href="GetMoreAttentionwithMotionfromAdobeStock.pdf" target="_blank"><strong>通过Adobe中的运动获得更多关注 [!DNL Stock] (PDF)</strong></a>
    </div>
  ...
  <td>
   <a href="ShowcaseyourdatawithAdobeStockMotionGraphicTemplates.pdf" target="_blank">
    ...
    <div>
   <a href="ShowcaseyourdatawithAdobeStockMotionGraphicTemplates.pdf" target="_blank"><strong>使用Adobe [!DNL Stock] 动态图形模板(PDF)</strong></a>
    </div>
...
<tr>
  <td>
   ...
   <a href="ShowOffYourDesignWorkintheRealWorld.pdf" target="_blank"><strong>在现实世界中展示您的设计作品(PDF)</strong></a>
    ...
    <em>了解如何使用来自Adobe的真实模板模拟您的设计作品 [!DNL Stock]</em>
    <br>
  </td>
<td>
   <a href="TipsforCreatingAnimationinEmailwithAdobeStock.pdf" target="_blank">
      <img alt="有关在电子邮件中创建动画并带有Adobe的提示 [!DNL Stock]" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
   <a href="TipsforCreatingAnimationinEmailwithAdobeStock.pdf" target="_blank"><strong>有关在电子邮件中创建动画并带有Adobe的提示 [!DNL Stock] (PDF)</strong></a>
    </div>
...
<tr>
  <td>
   ...
   <a href="CreatingRealistic3DMock-upswithAdobeStockandDimension.pdf" target="_blank"><strong>使用Adobe创建逼真的3D模型 [!DNL Stock] 和 [!DNL Dimension] (PDF)</strong></a>
    ...
    <em>了解通过合并3D模型和Adobe [!DNL Stock] 包含自定义贴纸的 [!DNL Dimension]</em>
    <br>
  </td>
  <td>
   <a href="SkiptheShootGettheShot.pdf" target="_blank">
    ...
    <div>
   <a href="SkiptheShootGettheShot.pdf" target="_blank"><strong>跳过拍摄 — 开始拍摄(PDF)</strong></a>
    </div>
...
<tr>
  <td>
   <a href="CreateAnimationsinRealTimewithCharacterAnimator.pdf" target="_blank">
    ...
    <div>
   <a href="CreateAnimationsinRealTimewithCharacterAnimator.pdf" target="_blank"><strong>使用Character Animator实时创建动画(PDF)</strong></a>
    </div>
    <em>使用您的面部表情创建具有表现力的Character Animator</em>
    <br>
  </td>
 <td>
   <a href="IntrotoAnimationwithAfterEffects.pdf" target="_blank">
      <img alt="动画与After Effects" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
   <a href="IntrotoAnimationwithAfterEffects.pdf" target="_blank"><strong>动画与After Effects介绍(PDF)</strong></a>
    </div>
    <em>通过在After Effects中将视频与图形和文本结合来创建动画合成</em>
    <br>
  </td>
  <td>
   <a href="PremiereProforDesigners.pdf" target="_blank">
      <img alt="Premiere Pro设计人员" src="../assets/acrobat_PDF_96.png" />
   </a>
    <div>
   <a href="PremiereProforDesigners.pdf" target="_blank"><strong>设计人员Premiere Pro(PDF)</strong></a>
    </div>
  ...
  <td>
   <a href="ShootEditPublishyourVideoswithCreativeCloud.pdf" target="_blank">
    ...
    <div>
   <a href="ShootEditPublishyourVideoswithCreativeCloud.pdf" target="_blank"><strong>拍摄、编辑、发布带有Creative Cloud的照片(PDF)</strong></a>
    </div>
...
<tr>
  ...
  <td>
   <a href="DesignandPrototypeInteractiveProjectswithCreativeCloud.pdf" target="_blank">
    ...
    <div>
   <a href="DesignandPrototypeInteractiveProjectswithCreativeCloud.pdf" target="_blank"><strong>设计交互式项目并为其创建原型Creative Cloud(PDF)</strong></a>
    </div>
  ...
  <td>
   <a href="LetsXDSeeHowtoDesignPrototypeandHandofftoTeams.pdf" target="_blank">
    ...
    <div>
   <a href="LetsXDSeeHowtoDesignPrototypeandHandofftoTeams.pdf" target="_blank"><strong>让我们来XD — 了解如何设计、创建原型以及将内容移交给团队(PDF)</strong></a>
    </div>
